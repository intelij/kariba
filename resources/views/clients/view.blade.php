...
<div class="sbox ">
	...
	<div class="sbox-tools" >
   		<a href="{{ URL::to('clients?return='.$return) }}" class="tips btn btn-xs btn-white pull-right" title="{{ Lang::get('core.btn_back') }}"><i class="icon-backward"></i>&nbsp;{{ Lang::get('core.btn_back') }}</a>
		@if($access['is_add'] ==1)
   		<a href="{{ URL::to('clients/update/'.$id.'?return='.$return) }}" class="tips btn btn-xs btn-white pull-right" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-edit"></i>&nbsp;{{ Lang::get('core.btn_edit') }}</a>
		@endif 
	</div>	
	</div>
		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						...
						<td>{{ date('',strtotime($row->date_of_birth)) }} </td>
					...
					<tr>
						...
						<td>{{ date('',strtotime($row->pay_date)) }} </td>
					...
					<tr>
						...
						<td>{!! SiteHelpers::formatRows($row->proof_of_id,$fields['proof_of_id'],$row ) !!} </td>
					...
					<tr>
						...
						<td>{!! SiteHelpers::formatRows($row->proof_of_residency,$fields['proof_of_residency'],$row ) !!} </td>
