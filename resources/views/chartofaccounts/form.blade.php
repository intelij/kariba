...
<div class="sbox">
	...
	<div class="sbox-content"> 	
		...
		<ul class="parsley-error-list">
		 ...
		 {!! Form::open(array('url'=>'chartofaccounts/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> Chart of Accounts</legend>
				{!! Form::hidden('id', $row['id']) !!}					
									  ...
									  <div class="form-group  " >
										<label for="Gl Code" class=" control-label col-md-4 text-left"> Gl Code </label>
										<div class="col-md-6">
										  {!! Form::text('gl_code', $row['gl_code'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group  " >
										<label for="Usage" class=" control-label col-md-4 text-left"> Usage </label>
										<div class="col-md-6">
										  {!! Form::text('usage', $row['usage'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
										 </div> 
										 <div class="col-md-2">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('chartofaccounts?return='.$return) }}' " class="btn btn-warning btn-sm "><i class="icon-cancel-circle2 "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#type").jCombo("{!! url('chartofaccounts/comboselect?filter=chart_of_account_type:type:type') !!}",
		{  selected_value : '{{ $row["type"] }}' });
		 

		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("chartofaccounts/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
