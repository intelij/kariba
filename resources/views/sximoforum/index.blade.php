...
<div class="sbox animated fadeInRight">
	<div class="sbox-title"> <h4> <i class="fa fa-comment"></i>  All Forums </h4>
<div class="sbox-tools" >
			...
			<i class="icon-remove"></i>&nbsp;{{ Lang::get('core.btn_remove') }}</a>
			@endif 
		@if(Session::get('gid') ==1)
			<a href="{{ URL::to('sximo/module/config/'.$pageModule) }}" class="btn btn-white tips" title=" {{ Lang::get('core.btn_config') }}" ><i class="fa fa-cog"></i></a>
		@endif 
		</div>
	</div>
	<div class="sbox-content"> 	
		...
		@foreach ($forums as $row)
			<tr>
				...
				@if($access['is_edit'] ==1)
				<td>
						<a  href="{{ URL::to('sximoforum/update/'.$row['ForumID'].'?return='.$return) }}" class="tips btn btn-xs btn-white" title="{{ Lang::get('core.btn_edit') }}"><i class="icon-pencil "></i></a>
				</td>		
				@endif
