		...
		<div id="wrapper">
			...
			<div id="topBar">
				<div class="container">
					...
					<span>Warning: Late repayment can cause you serious money problems. For help, go to <a target="_new" href="http://www.moneyadviceservice.org.uk">moneyadviceservice.org.uk</a></span>
					...
					<div class="container">
						...
						<!-- Logo -->
							...
							<a class="logo pull-left" style="font-size:30px;" href="{{ url()}}">
								{{--width="150"--}}
							<img src="{{ asset('frontend/default/images/sximo_logo.png')}}"  title="{{ CNF_APPNAME }} " style="height: 50px !important" />
			...
			<footer id="footer">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<!-- Footer Logo -->
							<img class="footer-logo" src="images/footer_logo.png" alt="" width="180"/>
