...
class FaqsController extends Controller {
	...
	public function getShow( Request $request, $id = null)
	{
		...
		if($row)
		{
			...
			return Redirect::to('faqs')->with('messagetext','Record Not Found !')->with('msgstatus','error');					
		}
	}	
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			...
			return Redirect::to('faqs/update/'.$request->input('faqID'))->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
	...
	function postSavepublic( Request $request)
	{
		...
		$validator = Validator::make($request->all(), $rules);	
		if ($validator->passes()) {
			$data = $this->validatePost('faq');		
			 $this->model->insertRow($data , $request->input('faqID'));
